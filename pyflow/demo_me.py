...
parser.add_argument(
    '-image1', default='examples/car1.jpg')
parser.add_argument(
    '-image2', default='examples/car2.jpg')
parser.add_argument(
    '-out_path', default='./')
parser.add_argument(
...
im1 = np.array(Image.open(args.image1))
im2 = np.array(Image.open(args.image2))
...
np.save(os.path.join(args.out_path, 'outFlow.npy'), flow)
...
if args.viz:
    ...
    cv2.imwrite(os.path.join(args.out_path, 'outFlow_new.png'), rgb)
    # cv2.imwrite('examples/car2Warped_new.jpg', im2W[:, :, ::-1] * 255)
    cv2.imwrite(os.path.join(args.out_path, 'warped_new.jpg'), im2W[:, :, ::-1] * 255)
