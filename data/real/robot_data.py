...
class RobotData(RealData):
    def __init__(self, args):
        super(RobotData, self).__init__(args)
        self.name = 'robot'
        self.train_dir = '/home/yi/code/video_motion_data/robot%d-train' % args.resolution
        self.test_dir = '/home/yi/code/video_motion_data/robot%d-test' % args.resolution
